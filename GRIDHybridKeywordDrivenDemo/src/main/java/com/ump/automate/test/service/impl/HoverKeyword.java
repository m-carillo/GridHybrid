...
/**
 * this class implements ActionKeyword and performs HOVER functionionality through xpath identifier
 * @author edward.cervantes
 */
public class HoverKeyword implements ActionKeyword {
    ...
    public boolean isPerform(String pageObjectId, String dataInput, WebDriver driver) throws Exception {
        ...
        try {
            ...
            log.info(new StringBuilder("Hovering on Webelement: ").append(pageObjectId).toString());
            ...
            if (assertElement.isElementPerformable(locator, driver)) {
                ...
                WebElement myDynamicElement = (new WebDriverWait(driver, 10)).until(ExpectedConditions.visibilityOfElementLocated(locator));
            ...
            isWorking = false;
            reasonMessage = new StringBuilder("Not able to hover due to ").append(e.getMessage()).append("...").toString();
