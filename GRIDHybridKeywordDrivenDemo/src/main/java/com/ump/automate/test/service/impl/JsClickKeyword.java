...
/**
 * this class implements ActionKeyword and performs the CLICK functionality through xpath identifier
 * @author edward.cervantes
 */
public class JsClickKeyword implements ActionKeyword {

    private static final Logger log = Logger.getLogger(JsClickKeyword.class);
